class AddPrecisionToDecimalColumns < ActiveRecord::Migration
  def change
    ...
    change_column :users, :rating,     :decimal, precision: 11, scale: 11
    change_column :users, :deviation,  :decimal, precision: 11, scale: 11
    change_column :users, :volatility, :decimal, precision: 11, scale: 11
  end
end
